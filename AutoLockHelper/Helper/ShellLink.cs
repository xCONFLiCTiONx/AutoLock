...
namespace AutoLockHelper.Helper
{
    /// <summary>
    ...
    internal class ShellLink : IDisposable
    {
        ...
        internal string TargetPath
        {
            get
            {
                ...
                VerifySucceeded(this.shellLink.GetPath(sb, sb.Capacity, ref data, SLGP.UNCPRIORITY));
        ...
        internal void Load(string shortcutPath)
        {
            ...
            this.PersistFile.Load(shortcutPath, (int)STGM.READ);
        }
    ...
    internal static class NativeMethods
    {
        ...
        internal extern static void PropVariantClear([In, Out] ShellLink.PropVariant pvar); // Or ref
    }
}